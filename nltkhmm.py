...
train = list(nltk.corpus.TaggedCorpusReader("/Users/Maria/Documents/ITandcognition/bin/twitter-POS/train.google",sys.argv[1],sep="/").tagged_sents())
test = list(nltk.corpus.TaggedCorpusReader("/Users/Maria/Documents/ITandcognition/bin/twitter-POS/train.google",sys.argv[2],sep="/").tagged_sents())
