...
train = list(nltk.corpus.TaggedCorpusReader("/Users/Maria/Documents/ITandcognition/Github/SPExam4/twitter-POS",sys.argv[1],sep="/").tagged_sents())
test = list(nltk.corpus.TaggedCorpusReader("/Users/Maria/Documents/ITandcognition/Github/SPExam4/twitter-POS",sys.argv[2],sep="/").tagged_sents())
